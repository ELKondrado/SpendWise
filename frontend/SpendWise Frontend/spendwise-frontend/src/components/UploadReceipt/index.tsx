...
export const UploadReceipt: FC = () => {
  ...
  const handleCategoryChange = (
    ...
    const filteredCategorizedProdcuts = categorizedProducts.map((el) => {
      el.products = el.products.filter((el) => el.name !== product.name);
      return el;
    });

    if (!filteredCategorizedProdcuts.find((el) => el.id === newCategoryId)) {
      ...
      filteredCategorizedProdcuts.push(newCategorizedProduct);
    }

    const newCategorizedProducts = filteredCategorizedProdcuts.map((el) => {
